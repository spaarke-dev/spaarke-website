{/*
  ...
  HERO IMAGE
  - SVG produced directly per `voice/visual-identity.md`. Path:
    `public/articles/welcome-to-spaarke/hero.svg`. Concept: three concentric
    rotated frames around a small Spaarke-blue cube — a system held inside a
    tenant boundary held inside a governance boundary.
...
If you read one thing after this, read [What is Legal Operations Intelligence?](/why-spaarke/what-is-legal-operations-intelligence) — the category piece this writing builds on. If you want to see what the platform actually does, [the platform page](/platform) names the five capability modules and the two deployment models. And if you want the structural reason any of this works, [Why we built on Microsoft](/why-spaarke/why-we-built-on-microsoft) is the architectural case.
