{/*
  ...
  HERO IMAGE
  - Placeholder path. The hero prompt lives in `briefs/2026-05-11-welcome-to-spaarke.md`
    § Hero graphic (per `voice/visual-identity.md`). Generate the image, drop it at
    `/images/blog/welcome-to-spaarke.jpg`, and the placeholder resolves.
