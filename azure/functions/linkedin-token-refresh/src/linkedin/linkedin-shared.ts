// COPY of c:\code_files\spaarke-website\scripts\linkedin-shared.ts — keep in sync if the canonical version changes. Duplicated because Azure Functions deployment requires self-contained bundles.
//
