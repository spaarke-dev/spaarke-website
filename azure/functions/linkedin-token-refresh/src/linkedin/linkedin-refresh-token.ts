// COPY of c:\code_files\spaarke-website\scripts\linkedin-refresh-token.ts — keep in sync if the canonical version changes. Duplicated because Azure Functions deployment requires self-contained bundles.
//
...
// the full contract.
//
// NOTE: import path differs from the canonical version — the canonical
// script imports from "./linkedin-shared.ts" (Node native TS), while
// this Functions copy is compiled by tsc and resolves the .js output.
