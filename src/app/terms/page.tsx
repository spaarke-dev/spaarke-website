      ...
      <Shell>
        ...
        <div className="text-fg-mid mt-12 max-w-2xl space-y-6 text-base leading-relaxed">
          ...
          <p>
            ...
            built on Spaarke Foundry IQ and the Microsoft Agent Framework,
            with surfaces in Microsoft Power Platform and Microsoft 365
            (including Microsoft 365 Copilot, Word, Outlook, and Teams).
            These features may summarize documents, classify
