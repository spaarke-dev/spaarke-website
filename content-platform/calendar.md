...
| knowledge-management-legal-operations-intelligence | blog-post | 2026-09-15 | brief | spaarke | 2026-06-legal-operations-intelligence |  |  | Article 5 of 5 in the Legal Operations Intelligence series, and its close. It covers knowledge management in a corporate legal department and what AI has changed about it, now that the department's own knowledge is the context its AI systems depend on. The date shown is the display date (frontmatter `date`); the real publish date goes in `posted`. Issue [#81](https://github.com/spaarke-dev/spaarke-website/issues/81). |
