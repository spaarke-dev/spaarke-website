# Tasks: legal-operations-ontology-syndication
...
- [ ] Article-syndication header at `public/articles/legal-operations-ontology/linkedin-1920x1080.png`
      (the source article's hero, reused unchanged; regenerated 2026-09-24 in gold)
- [ ] Alt text written

## 6. Ship (gate: live + tracked)

- [ ] `draft.md` moved to `content-platform/published/linkedin-posts/legal-operations-ontology-syndication.md`
- [ ] Posted to LinkedIn (manual; capture the LinkedIn URL in
      `published/linkedin-posts/legal-operations-ontology-syndication.md` frontmatter as `posted_url`)
