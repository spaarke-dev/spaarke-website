# Per-piece session contract: building-the-legal-operations-intelligence-platform
...
- **Campaign:** `2026-06-legal-operations-intelligence` (the
  ...
  narrative arc this piece sits inside: this is article 2 of 5, display
  date 2026-07-14, between The New Mandate for Legal Operations
  (article 1, 2026-06-16) and The Legal Operations Intelligence
  Ontology (article 3, 2026-07-21). The campaign file also carries the
  rules the series shares (date discipline, frontmatter, positioning,
  voice, research) and the GitHub milestone, "2026-06 Legal Operations
  Intelligence", number 5.
- **Calendar row:** `../../calendar.md`, 2026-07 section (this piece's
  row, for cadence and cross-references; the row is added by the
  `content-pipeline` skill's calendar step). The campaign-level row is
  in `../../campaigns/calendar.md`.
- **GitHub Issue:** see the `github_issue:` field in the `brief.md`
  frontmatter for status tracking (added by the `content-pipeline`
  skill's Issue step).
...
1. **The lint, before any gate is marked done.** From the repository
   root: `npm run voice:lint -- content-platform/articles/building-the-legal-operations-intelligence-platform/draft.mdx`.
