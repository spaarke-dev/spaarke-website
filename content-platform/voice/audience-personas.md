...
**Role**: GC, Deputy GC, or AGC at a Fortune 1000 or upper-mid-market company (legal department of 8 to 60).
**Primary or secondary?**: primary

### What they're hired for

They own legal risk, the operational performance of the legal function, and outside-counsel spend, which is the second- or third-largest line in their function. The board expects predictability: known cost, known cycle time, no unbudgeted blow-ups. They are promoted on whether the department runs like a function the CFO can plan around.

### What they care about

- Outside-counsel spend visibility by matter, panel firm, and practice area, with enough fidelity to enforce OCG in real time.
...
- "Replaces lawyers" or "10x the legal department", both of which read as ignorance or willingness to mislead.
...
- AI vendors who don't understand real legal workflows, meaning products built by people who have never sat through an intake-routing review or an OCG dispute.
...
Architectural pieces written for an architect, covering the tenant model, identity, grounding, and what data crosses what boundary. `why-we-built-on-microsoft` and `tenant-dedicated-deployment` are the template: defensible technical claims with structural reasons.
...
**Role**: Managing Partner, COO, or Director of Practice Management at a firm of 20 to 500 attorneys.
**Primary or secondary?**: secondary
...
- Realization against client OCG terms, with variances explained without a week of timekeeper reconciliation.
...
- Service-delivery quality on matter execution, because the firm's reputation rests on the work, not on how cleverly the time was logged.
- Operational efficiency that protects partnership economics rather than eroding them, meaning modernization that improves margin, not one that quietly compresses it.
...
- Corporate-counsel AI initiatives positioned only as a fee-reduction mechanism, which is the framing that treats the firm as a cost line, not a service partner.
