...
Two-column reference for word choice. Fastest doc to load when a draft reaches for a word and you need to know whether to use it. If a word needs more than a line of defense, it belongs in `style-guide.md` instead.

First draft. Team revises in T11.
...
| cutting-edge | (specific capability) | dates instantly and means nothing |
| innovative / innovation | (specific noun: capability, mechanism, design) | self-congratulatory and 2010s-flavored |
| disrupt / disruptor / disruption | (specific action) | startup register; we don't position as outsiders |
| seamless / seamlessly | (cut, or describe what's actually true) | empty word; almost always a tell |
| robust | (specific verb or capability) | meaningless adjective |
| powerful / powerfully | (specific capability) | tells without showing |
| unlock / unleash | (cut) | overused and vague |
| harness | use | corporate-speak |
...
| 10x productivity | (specific operational outcome) | unverifiable; not our story |
...
| at the end of the day / moving forward / going forward | (cut, or next / from here) | filler |
| dive deep / deep dive | examine / look closely at | cliché |
| journey (as in "your AI journey") | (cut) | sales-deck word |
| ecosystem (when "set of products" works) | platform / set of tools | overused; reserve for genuine ecosystems |
