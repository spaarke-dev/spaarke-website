...
│   ├── linkedin-post.md
│   └── tweet.md
├── articles/                            ← per-piece workspaces (the content equivalent of projects/<name>/)
│   ├── _template-blog-post/             ← workspace template per content type
│   │   ├── brief.md                     ← brief template (the spec)
